  ...
  <div class="card" style="width: 40rem;height:65rem;">
    ...
    <form class="form" method="POST" action="#">
        ...
        <div class="form-group">
            ...
            <!-- this is important if you do not change  it to tell then first 0 will not count in js-->
        ...
        <div class="form-group">
              ...
              <input type="button" id="register" name="register" value="register" class="btn btn-primary btn-lg btn-block" >
